...
class LoadTournamentTable:
    ...
    def process_tournament_table(self, filename, clean_df, output_folder_path):
        ...
        self.writeSingleSparringTreeandDivisionReport(event_time="9:45am",division_name="Youth Girl's Sparring",gender="Female", rank_label="Orange",                    minimum_age=7, maximum_age=8, rings=[8], ranks=[constants.ORANGE_BELT],clean_df=clean_df)
        ...
        self.writeSingleKataScoreSheetandDivisionReport(event_time="9:45am",division_name="Boy's & Girl's Kata",gender="*", rank_label="Purple",                minimum_age=9, maximum_age=11, rings=[15,16], ranks=[constants.PURPLE_BELT], clean_df=clean_df)
        ...
        ### White/Yellow/Orange
        self.writeSingleTechniqueScoreSheetandDivisionReport(event_time="11:15am",division_name="Defense Technique",gender="*", rank_label="White, Yellow, Orange", minimum_age=4,   maximum_age=11,                rings=[1], ranks=[constants.WHITE_BELT,constants.YELLOW_BELT,constants.ORANGE_BELT],clean_df=clean_df)
        self.writeSingleTechniqueScoreSheetandDivisionReport(event_time="11:15am",division_name="Defense Technique",gender="*", rank_label="White, Yellow, Orange", minimum_age=12,  maximum_age=17,                rings=[2], ranks=[constants.WHITE_BELT,constants.YELLOW_BELT,constants.ORANGE_BELT],clean_df=clean_df)
        self.writeSingleTechniqueScoreSheetandDivisionReport(event_time="11:15am",division_name="Defense Technique",gender="*", rank_label="White, Yellow, Orange", minimum_age=18,  maximum_age=39,                rings=[3], ranks=[constants.WHITE_BELT,constants.YELLOW_BELT,constants.ORANGE_BELT],clean_df=clean_df)
        self.writeSingleTechniqueScoreSheetandDivisionReport(event_time="11:15am",division_name="Defense Technique",gender="*", rank_label="White, Yellow, Orange", minimum_age=40,  maximum_age=constants.AGELESS, rings=[1], ranks=[constants.WHITE_BELT,constants.YELLOW_BELT,constants.ORANGE_BELT],clean_df=clean_df)

        ### Purple/Blue/Blue Stripe
        self.writeSingleTechniqueScoreSheetandDivisionReport(event_time="11:15am",division_name="Defense Technique",gender="*", rank_label="Purple, Blue, Blue/stripe", minimum_age=4,   maximum_age=11,                rings=[5], ranks=[constants.PURPLE_BELT,constants.BLUE_BELT,constants.BLUE_STRIPE_BELT],clean_df=clean_df)
        self.writeSingleTechniqueScoreSheetandDivisionReport(event_time="11:15am",division_name="Defense Technique",gender="*", rank_label="Purple, Blue, Blue/stripe", minimum_age=12,  maximum_age=17,                rings=[6], ranks=[constants.PURPLE_BELT,constants.BLUE_BELT,constants.BLUE_STRIPE_BELT],clean_df=clean_df)
        self.writeSingleTechniqueScoreSheetandDivisionReport(event_time="11:15am",division_name="Defense Technique",gender="*", rank_label="Purple, Blue, Blue/stripe", minimum_age=18,  maximum_age=39,                rings=[7], ranks=[constants.PURPLE_BELT,constants.BLUE_BELT,constants.BLUE_STRIPE_BELT],clean_df=clean_df)
        self.writeSingleTechniqueScoreSheetandDivisionReport(event_time="11:15am",division_name="Defense Technique",gender="*", rank_label="Purple, Blue, Blue/stripe", minimum_age=40,  maximum_age=constants.AGELESS, rings=[8], ranks=[constants.PURPLE_BELT,constants.BLUE_BELT,constants.BLUE_STRIPE_BELT],clean_df=clean_df)
        ...
        self.writeSingleTechniqueScoreSheetandDivisionReport(event_time="11:15am",division_name="Defense Technique",gender="*", rank_label="Green, Green/Stripe, Brown", minimum_age=40, maximum_age=constants.AGELESS, rings=[12], ranks=[constants.GREEN_BELT,constants.GREEN_STRIPE_BELT,constants.THIRD_DEGREE_BROWN_BELT,constants.SECOND_DEGREE_BROWN_BELT,constants.FIRST_DEGREE_BROWN_BELT],clean_df=clean_df)
        ...
        self.writeWeaponsDivisionToSingleKataScoreSheetandDivisionReport(event_time="12:00noon",division_name="Weapons Division 2-new",gender="*", rank_label="White to Blue w/Green Stripe", minimum_age=9, maximum_age=11, rings=['*TBA'],
        ...
        self.writeWeaponsDivisionToSingleKataScoreSheetandDivisionReport(event_time="12:00noon",division_name="Weapons Division 3-new",gender="*", rank_label="Green - Jr. Black", minimum_age=9, maximum_age=11, rings=['*TBA'],
