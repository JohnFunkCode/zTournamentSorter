...
# from eight_competitor_tree import NewSixteenCompetitorTree
...
class TestNewSixteenCompetitorTree(unittest.TestCase):
    ''' class to test the SixteenCompettitorTree code'''

    @classmethod
    def setUpClass(cls):
        '''Set the cwd to the project root before any tests run'''
    ...
    def test_creating_a_file(self):
        ...
        test_file_name = "reports//sparring_tree//testoutput//16PersonTree_Create_File.pdf"
        test_canvas = canvas.Canvas(test_file_name)
        tree = NewSixteenCompetitorTree(test_canvas, test_file_name)
    ...
    def test_creating_a_file_with_two_tree(self):
        ...
        test_file_name = "reports//sparring_tree//testoutput//16PersonTree_Two_Trees.pdf"
        test_canvas = canvas.Canvas(test_file_name)
        tree = NewSixteenCompetitorTree(test_canvas, test_file_name)
    ...
    def test_initialize_text_coordinates(self):
        ...
        test_file_name = "reports//sparring_tree//testoutput//16PersonTree_Init_Text_Coords.pdf"
        test_canvas = canvas.Canvas(test_file_name)
        tree = NewSixteenCompetitorTree(test_canvas, test_file_name)
    ...
    def test_draw_16_names_on_tree(self):
        ''' tests to make sure the names in a 16 person tree get put in the right place'''
        names = SIXTEEN_NAMES
        self.draw_n_names_on_tree(names, "reports//sparring_tree//testoutput//16PeopleOn16PersonTree.pdf")

    def test_draw_15_names_on_tree(self):
        ''' tests to make sure the names in a 16 person tree get put in the right place'''
        names = SIXTEEN_NAMES[0:15]
        self.draw_n_names_on_tree(names, "reports//sparring_tree//testoutput//15PeopleOn16PersonTree.pdf")

    def test_draw_14_names_on_tree(self):
        ''' tests to make sure the names in a 16 person tree get put in the right place'''
        names = SIXTEEN_NAMES[0:14]
        self.draw_n_names_on_tree(names, "reports//sparring_tree//testoutput//14PeopleOn16PersonTree.pdf")

    def test_draw_13_names_on_tree(self):
        ''' tests to make sure the names in a 16 person tree get put in the right place'''
        names = SIXTEEN_NAMES[0:13]
        self.draw_n_names_on_tree(names, "reports//sparring_tree//testoutput//13PeopleOn16PersonTree.pdf")

    def test_draw_12_names_on_tree(self):
        ''' tests to make sure the names in a 16 person tree get put in the right place'''
        names = SIXTEEN_NAMES[0:12]
        self.draw_n_names_on_tree(names, "reports//sparring_tree//testoutput//12PeopleOn16PersonTree.pdf")

    def test_draw_11_names_on_tree(self):
        ''' tests to make sure the names in a 16 person tree get put in the right place'''
        names = SIXTEEN_NAMES[0:11]
        self.draw_n_names_on_tree(names, "reports//sparring_tree//testoutput//11PeopleOn16PersonTree.pdf")

    def test_draw_10_names_on_tree(self):
        ''' tests to make sure the names in a 16 person tree get put in the right place'''
        names = SIXTEEN_NAMES[0:10]
        self.draw_n_names_on_tree(names, "reports//sparring_tree//testoutput//10PeopleOn16PersonTree.pdf")

    def test_draw_9_names_on_tree(self):
        ''' tests to make sure the names in a 16 person tree get put in the right place'''
        names = SIXTEEN_NAMES[0:9]
        self.draw_n_names_on_tree(names, "reports//sparring_tree//testoutput//9PeopleOn16PersonTree.pdf")

    def test_draw_8_names_on_tree(self):
        ''' tests to make sure the names in a 16 person tree get put in the right place'''
        names = SIXTEEN_NAMES[0:8]
        self.draw_n_names_on_tree(names, "reports//sparring_tree//testoutput//8PeopleOn16PersonTree.pdf")

    def test_draw_7_names_on_tree(self):
        ''' tests to make sure the names in a 16 person tree get put in the right place'''
        names = SIXTEEN_NAMES[0:7]
        self.draw_n_names_on_tree(names, "reports//sparring_tree//testoutput//7PeopleOn16PersonTree.pdf")

    def test_draw_6_names_on_tree(self):
        ''' tests to make sure the names in a 16 person tree get put in the right place'''
        names = SIXTEEN_NAMES[0:6]
        self.draw_n_names_on_tree(names, "reports//sparring_tree//testoutput//6PeopleOn16PersonTree.pdf")

    def test_draw_5_names_on_tree(self):
        names = SIXTEEN_NAMES[0:5]
        self.draw_n_names_on_tree(names, "reports//sparring_tree//testoutput//5PeopleOn16PersonTree.pdf")

    def test_draw_4_names_on_tree(self):
        ''' tests to make sure the names in a 16 person tree get put in the right place'''
        names = SIXTEEN_NAMES[0:4]
        self.draw_n_names_on_tree(names, "reports//sparring_tree//testoutput//4PeopleOn16PersonTree.pdf")

    def test_draw_3_names_on_tree(self):
        ''' tests to make sure the names in a 16 person tree get put in the right place'''
        names = SIXTEEN_NAMES[0:3]
        self.draw_n_names_on_tree(names, "reports//sparring_tree//testoutput//3PeopleOn16PersonTree.pdf")
    ...
    def test_draw_2_names_on_tree(self):
        ...
        self.draw_n_names_on_tree(names, "reports//sparring_tree//testoutput//2PeopleOn16PersonTree.pdf")
    ...
    def test_draw_1_names_on_tree(self):
        ...
        self.draw_n_names_on_tree(names, "reports//sparring_tree//testoutput//1PeopleOn16PersonTree.pdf")
    ...
    def test_draw_competitors_on_tree(self):
        ...
        # setup a 16 person tree
        test_file_name = "reports//sparring_tree//testoutput//16PersonTree_from_competitors.pdf"
        test_canvas = canvas.Canvas(test_file_name)
        tree = NewSixteenCompetitorTree(test_canvas, test_file_name)
        tree.draw_static_template()
    ...
    def test_add_page_with_competitors_on_tree(self):
        ...
        # setup a 16 person tree
        test_file_name = "reports//sparring_tree//testoutput//16PersonTree_full_page.pdf"
        test_canvas = canvas.Canvas(test_file_name)
        tree = NewSixteenCompetitorTree(test_canvas, test_file_name)
